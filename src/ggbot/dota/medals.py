...
__all__ = ["PlayerMedal", "PLAYER_MEDALS", "PLAYER_MEDALS_DICT"]
...
PLAYER_MEDALS = [
    ...
    PlayerMedal(
        ...
        predicate=And(
            PermanentBuffStacksMoreThan(
                buff_id=PermanentBuffIds.aghanims_shard, stacks=-1
            ),
            PermanentBuffStacksMoreThan(
                buff_id=PermanentBuffIds.ultimate_scepter, stacks=-1
            ),
        ),
    ),
    PlayerMedal(
    ...
    PlayerMedal(
        ...
        predicate=PermanentBuffStacksMoreThan(
            buff_id=PermanentBuffIds.silencer_glaives_of_wisdom, stacks=60
        ),
    ),
    PlayerMedal(
        ...
        predicate=PermanentBuffStacksMoreThan(
            buff_id=PermanentBuffIds.pudge_flesh_heap, stacks=30
        ),
    ),
    PlayerMedal(
        ...
        predicate=PermanentBuffStacksMoreThan(
            buff_id=PermanentBuffIds.lion_finger_of_death, stacks=7
        ),
    ),
    PlayerMedal(
        ...
        predicate=PermanentBuffStacksMoreThan(
            buff_id=PermanentBuffIds.legion_commander_duel, stacks=300
        ),
    ),
    PlayerMedal(
        ...
        predicate=PermanentBuffStacksMoreThan(
            buff_id=PermanentBuffIds.slark_essence_shift, stacks=30
        ),
    ),
    PlayerMedal(
        ...
        predicate=PermanentBuffStacksMoreThan(
            buff_id=PermanentBuffIds.bounty_hunter_jinada, stacks=500
        ),
    ),
    PlayerMedal(
        id="lots_of_buybacks",
    ...
    PlayerMedal(
        ...
        predicate=PermanentBuffStacksMoreThan(
            buff_id=PermanentBuffIds.tome_of_knowledge, stacks=4
        ),
    ),
    PlayerMedal(
        id="low_net_worth",
